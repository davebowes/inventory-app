      ...
      <div className="list">
        {items.map((l) => (
          <div key={l.id} className="listRow">
            ...
            <button onClick={() => void del(l.id)} className="btnDanger listRowAction" type="button">
              Delete
            </button>
          </div>
        ))}
      ...
      <div className="list">
        {items.map((mt) => (
          <div key={mt.id} className="listRow">
            ...
            <button onClick={() => void del(mt.id)} className="btnDanger listRowAction" type="button">
              Delete
            </button>
          </div>
        ))}
      ...
      <div className="list">
        {items.map((v) => (
          <div key={v.id} className="listRow">
            ...
            <button className="btnDanger listRowAction" type="button" onClick={() => void del(v.id)}>
              Delete
            </button>
          </div>
        ))}
